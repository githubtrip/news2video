...
class News2Video():
    def __init__(self, url):
        ...
        #sys.exit(1)
        self.imgroot = r'testimg/' + self.name
        self.videoroot = r'testavi/' + self.name
    ...
    def text2Audio(self, text, name):
        audiopath = r'%s-%s.mp3' % (self.name, name)
...
if __name__ == "__main__":
    ...
    #news2video = News2Video("http://www.cankaoxiaoxi.com/photo/20200313/2404487.shtml")
    news2video = News2Video("http://www.cankaoxiaoxi.com/photo/20201116/2424799.shtml")
